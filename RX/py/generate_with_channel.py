...
def generate_ofdm_mem(image_path, n_fft=128, cp_len=32, dim=32, f_cfo_norm=0.0035, snr_db=30):
...
# Execution
tx_bits = generate_ofdm_mem("input.jpeg", dim=64, f_cfo_norm=0.0002, snr_db=20)  
# max cfo is  0.0035